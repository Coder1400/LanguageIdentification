...
3.)  My word bigram language model implementation, with Good Turing smoothing,  was able to correctly predict the test data at a rate of <strong> 99.66% </strong>! There was only one instance where my program incorrectly predicted an input sentence. 
